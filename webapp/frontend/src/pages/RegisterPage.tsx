 ...
 *
 * The confirm-password field is here because password reset is not built yet.
 * Until it is, a typo in the password box is unrecoverable — so we make the typo
 * hard to commit rather than easy to regret.
 */
