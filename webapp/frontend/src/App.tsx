 ...
 * routes. No route below is protected: the board is public and accounts gate
 * nothing (docs/adr/0002). /account is the single page that needs a Seeker, and
 * it redirects itself rather than being wrapped in a guard.
 */
