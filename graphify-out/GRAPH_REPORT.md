...
Cohesion: 0.29
Nodes (6): Architecture (the shape of the solution), CLAUDE.md — HK Financial Job Scraper, Exception: LinkedIn recruiter posts ("Secret Market"), Tech stack (decided — do not substitute without asking), What we are building, Working agreement with the human
...
Cohesion: 0.10
Nodes (31): ApiError, apiFetch(), authError(), CAREER_STAGES, deleteAccount(), EnquiryPayload, fetchFilters(), fetchJobDetail() (+23 more)
